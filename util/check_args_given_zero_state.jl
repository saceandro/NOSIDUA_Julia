...
check_params_length(true_params, initial_lower_bounds) = length(true_params) == length(initial_lower_bounds) || ArgParse.argparse_error("length of initial_lower_bounds and initial_upper_bounds must be equal to the length of true_params")

mutable struct Model{N, L, T<:AbstractFloat, A<:AbstractVector, B<:AbstractMatrix, C<:AbstractArray, F<:Function, G1<:Function, G2<:Function, H1<:Function, H2<:Function, H3<:Function, I<:Function, J<:Function, K<:Function, M<:Function} #<: AbstractModel{N, L, T, A, B, C, F, G, H}
    ...
    time_point::A
    Δtime_point::A
    Model{N, L, T, A, B, C, F, G1, G2, H1, H2, H3, I, J, K, M}(dxdt::AbstractVector{T}, jacobianx::AbstractMatrix{T}, jacobianp::AbstractMatrix{T}, hessianxx::AbstractArray{T,3}, hessianxp::AbstractArray{T,3}, hessianpp::AbstractArray{T,3}, dxdt!::F, jacobianx!::G1, jacobianp!::G2, hessianxx!::H1, hessianxp!::H2, hessianpp!::H3, observation::I, d_observation::J, dd_observation::K, inv_observation::M, time_point::AbstractVector{T}, Δtime_point::AbstractVector{T}) where {N,L,T,A,B,C,F,G1,G2,H1,H2,H3,I,J,K,M} = new{N,L,T,A,B,C,F,G1,G2,H1,H2,H3,I,J,K,M}(dxdt, jacobianx, jacobianp, hessianxx, hessianxp, hessianpp, dxdt!, jacobianx!, jacobianp!, hessianxx!, hessianxp!, hessianpp!, observation, d_observation, dd_observation, inv_observation, time_point, Δtime_point)
end
...
function Model(t::Type{T}, N, L, time_point::AbstractVector{T}, dxdt!::F, jacobianx!::G1, jacobianp!::G2, hessianxx!::H1, hessianxp!::H2, hessianpp!::H3, observation::I, d_observation::J, dd_observation::K, inv_observation::M) where {T<:AbstractFloat, F<:Function, G1<:Function, G2<:Function, H1<:Function, H2<:Function, H3<:Function, I<:Function, J<:Function, K<:Function, M<:Function}
    ...
    Model{N, L, t, typeof(dxdt), typeof(jacobianx), typeof(hessianxx), typeof(dxdt!), typeof(jacobianx!), typeof(jacobianp!), typeof(hessianxx!), typeof(hessianxp!), typeof(hessianpp!), typeof(observation), typeof(d_observation), typeof(dd_observation), typeof(inv_observation)}(dxdt, jacobianx, jacobianp, hessianxx, hessianxp, hessianpp, dxdt!, jacobianx!, jacobianp!, hessianxx!, hessianxp!, hessianpp!, observation, d_observation, dd_observation, inv_observation, time_point, Δtime_point)
end

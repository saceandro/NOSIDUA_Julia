mutable struct Model{N, L, R, U, T<:AbstractFloat, A<:AbstractVector, B<:AbstractMatrix, C<:AbstractArray, F<:Function, G1<:Function, G2<:Function, H1<:Function, H2<:Function, H3<:Function, O<:Function, P<:Function, Q<:Function, I<:Function, J<:Function, K<:Function, M<:Function, S<:LinAlg.LU} #<: AbstractModel{N, L, T, A, B, C, F, G, H}
    dxdt::A
    jacobianx::B
    jacobianp::B
    hessianxx::C
    ...
    Model{N, L, R, U, T, A, B, C, F, G1, G2, H1, H2, H3, O, P, Q, I, J, K, M, S}(dxdt::AbstractVector{T}, jacobianx::AbstractMatrix{T}, jacobianp::AbstractMatrix{T}, hessianxx::AbstractArray{T,3}, hessianxp::AbstractArray{T,3}, hessianpp::AbstractArray{T,3}, observation::AbstractVector{T}, observation_jacobianx::AbstractMatrix{T}, observation_jacobianr::AbstractMatrix{T}, observation_hessianxx::AbstractArray{T,3}, observation_hessianxr::AbstractArray{T,3}, observation_hessianrr::AbstractArray{T,3}, dxdt!::F, jacobianx!::G1, jacobianp!::G2, hessianxx!::H1, hessianxp!::H2, hessianpp!::H3, calc_eqdot!::O, observation!::I, observation_jacobianx!::J, observation_jacobianr!::K, observation_hessianxx!::M, observation_hessianxr!::P, observation_hessianrr!::Q, time_point::AbstractVector{T}, Δtime_point::AbstractVector{T}, eqdot::AbstractVector{T}, rhs::AbstractVector{T}, spline_lhs::LinAlg.LU{T,Tridiagonal{T}}, spline_rhs::AbstractMatrix{T}, spline_lhs_inv::AbstractMatrix{T}, spline_lhs_inv_rhs::AbstractMatrix{T}) where {N,L,R,U,T,A,B,C,F,G1,G2,H1,H2,H3,O,P,Q,I,J,K,M,S} = new{N,L,R,U,T,A,B,C,F,G1,G2,H1,H2,H3,O,P,Q,I,J,K,M,S}(dxdt, jacobianx, jacobianp, hessianxx, hessianxp, hessianpp, observation, observation_jacobianx, observation_jacobianr, observation_hessianxx, observation_hessianxr, observation_hessianrr, dxdt!, jacobianx!, jacobianp!, hessianxx!, hessianxp!, hessianpp!, calc_eqdot!, observation!, observation_jacobianx!, observation_jacobianr!, observation_hessianxx!, observation_hessianxr!, observation_hessianrr!, time_point, Δtime_point, eqdot, rhs, spline_lhs, spline_rhs, spline_lhs_inv, spline_lhs_inv_rhs)
end

function Model(t::Type{T}, N, L, R, U, time_point::AbstractVector{T}, dxdt!::F, jacobianx!::G1, jacobianp!::G2, hessianxx!::H1, hessianxp!::H2, hessianpp!::H3, calc_eqdot!::O, observation!::I, observation_jacobianx!::J, observation_jacobianr!::K, observation_hessianxx!::M, observation_hessianxr!::P, observation_hessianrr!::Q) where {T<:AbstractFloat, F<:Function, G1<:Function, G2<:Function, H1<:Function, H2<:Function, H3<:Function, O<:Function, P<:Function, Q<:Function, I<:Function, J<:Function, K<:Function, M<:Function}
    _M = L-N
    dxdt = Array{t}(N)

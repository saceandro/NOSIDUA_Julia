...
function jacobian!(m::Model{N}, t, x, p) # might be faster if SparseMatrixCSC is used. L=N+M. need to write in one line
...
function hessian!(m::Model{N}, t, x, p)

...
include("../../src/types_backward_spline_obsparams2.jl")
include("../../src/adjoint_backward_spline_attenuation_obsparam2.jl")
...
@views function gradient_covariance_check_obs_m!(
    ...
    model = Model(typeof(dt), N, L, R, U, time_point, dxdt!, jacobianx!, jacobianp!, hessianxx!, hessianxp!, hessianpp!, calc_qdot!, observation!, observation_jacobianx!, observation_jacobianr!, observation_hessianxx!, observation_hessianxr!, observation_hessianrr!)
...
Base.@ccallable function julia_main(args::Vector{String})::Cint
    ...
    @add_arg_table settings begin
        ...
        "--parameters"
            ...
            arg_type = String
            nargs = '+'
            default = ["log_x0", "log_p", "log_u1", "log_u2", "log_u3", "r1", "r2"]
            # default = ["x0", "p", "u1", "u2"]
    end
    ...
    gradient_covariance_check_obs_m!(dxdt!, jacobianx!, jacobianp!, hessianxx!, hessianxp!, hessianpp!, calc_eqdot!, observation!, observation_jacobianx!, observation_jacobianr!, observation_hessianxx!, observation_hessianxr!, observation_hessianrr!; parsed_args...)

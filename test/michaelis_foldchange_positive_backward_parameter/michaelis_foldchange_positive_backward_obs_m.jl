using CatViews.CatView, NLSolversBase, NLsolve, Optim, Distributions, Juno, Gadfly, DifferentialEquations, ArgParse
...
@views function twin_experiment_obs_m!( # twin experiment with true and obs data logging
    ...
    srand(hash([true_params, initial_lower_bounds, initial_upper_bounds, pseudo_obs, pseudo_obs_var, obs_variance, obs_iteration, dt, spinup, duration, trials, newton_maxiter, replicates, iter]))

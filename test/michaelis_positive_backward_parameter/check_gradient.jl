using CatViews.CatView, Distributions, LineSearches, Optim, ArgParse, DataFrames, CSV, Gadfly, Juno

include("../../src/types_backward_nospline.jl")
include("../../src/adjoint_backward_nospline.jl")
...
Base.@ccallable function julia_main(args::Vector{String})::Cint
    ...
    @add_arg_table settings begin
        ...
        "--true-params", "-p"
            ...
            arg_type = Float64
            nargs = '*'
            default = [-1.2039728043, 0.0000000000, 1.6094379124, -1.8971199849]
        "--initial-lower-bounds", "-l"
            help = "lower bounds for initial state and parameters"
            arg_type = Float64
            nargs = '+'
            default = [-1., -1., -2.3025850930, -2.3025850930, 0.0000000000, -2.3025850930]
        "--initial-upper-bounds", "-u"
            help = "upper bounds for initial state and parameters"
            arg_type = Float64
            nargs = '+'
            default = [1., 1., 0.0000000000, 2.3025850930, 2.3025850930, 0.0000000000]
        "--pseudo-obs"
        ...
        "--parameters"
            ...
            arg_type = String
            nargs = '+'
            default = ["x", "m", "Km1", "Vmax1", "Km2", "Vmax2"]
    end
